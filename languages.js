...
export default [
  {
    ...
    colorMapping: {
      ...
      class_declaration:    commonColors.declaration,
  ...
  },
  {
    ...
    colorMapping: {
      ...
      class_definition:      commonColors.declaration,
      augmented_assignment:  commonColors.call,
      ...
      true:                  commonColors.primitive,
      false:                 commonColors.primitive,
      dictionary:            commonColors.collection,
